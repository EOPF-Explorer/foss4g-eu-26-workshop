...
This story uses a single Sentinel-2 GeoZarr scene over Napoli to compare band
combinations. Scroll down to move between the views.

## Band Combinations <!--{ as="eox-map" mode="tour" projection="EPSG:3857" }-->

<!-- Step 1 is filled in for you as a worked example: a True Color composite. -->
